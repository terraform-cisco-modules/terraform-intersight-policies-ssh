...
func TestFull(t *testing.T) {
	...
	instanceName := fmt.Sprintf("test-policies-ssh-%s", uniqueId)
...
`
	...
	iassert.AssertMOComply(t, fmt.Sprintf("/api/v1/ssh/Policies/%s", moid), expectedJSONTemplate, vars)
}
